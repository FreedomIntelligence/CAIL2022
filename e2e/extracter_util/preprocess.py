...
class Processor:
    ...
    def read_json(self, src_path):
        with open(src_path + "/" + self.type + "_out.jsonl", 'r', encoding='utf-8') as fp:
...
if __name__ == '__main__':
        ...
        processor.read_json(src_path="./")
        processor.write_file(des_path="./")
        processor.get_final_data(token_path="../xlnet-mid", src_path="./")
