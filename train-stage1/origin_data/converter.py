...
from origin_data.sample import Sample
import json
...
def create_train_dataset():
    ...
    for data_type in data_types:
        input_file = "./origin_data/" + data_type + ".jsonl"
        ...
        with open(input_file, encoding="utf-8", mode='r') as fr:
            ...
            for step, line in enumerate(tqdm(lines)):
                ...
                converter = Converter(origin_sample)
                converter.segment_sentences()
                converter.create_zero_text_list()
                converter.label_important_sentence(rouge_eval)
